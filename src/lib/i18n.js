...
const AlgoI18n = (() => {
  const STR = {
    id: {
      ...
      "hub.eyebrow": "Akun detektif",
      "hub.title": "Beranda akun",
      "hub.lead": "Mulai misi baru jika masih ada kredit, atau unduh sertifikat dari riwayat.",
      "hub.leadEmpty": "Kredit habis. Kamu masih bisa membuka & mengunduh sertifikat dari riwayat.",
      "hub.creditsLeft": "Kredit tersisa",
      "hub.creditsUsed": "Kredit dipakai",
      "hub.creditsTotal": "Total kredit",
      "hub.start": "Mulai misi baru →",
      "hub.noCredits": "Kredit habis",
      "hub.logout": "Ganti akun / Logout",
      "hub.history": "Riwayat & unduh",
      "hub.historyEmpty": "Belum ada riwayat. Selesaikan satu misi untuk melihatnya di sini.",
      "hub.openCert": "Buka sertifikat / PDF",
      ...
      "result.review": "Unduh soal, kunci & pembahasan",
      ...
      "review.print": "Cetak / Simpan PDF soal",
      "review.back": "← Kembali ke Hasil",
      "review.title": "Berkas Soal & Pembahasan",
      "review.kicker": "Setelah misi selesai",
      "review.lead": "Soal, jawabanmu, kunci, dan pembahasan. Khusus jawaban yang belum tepat, pembahasan ditandai lebih jelas.",
      "review.empty": "Berkas soal hanya tersedia setelah misi diselesaikan di perangkat ini.",
      "hub.openReview": "Soal & pembahasan",
    ...
    en: {
      ...
      "hub.eyebrow": "Detective account",
      "hub.title": "Account home",
      "hub.lead": "Start a new mission if you still have credits, or download certificates from history.",
      "hub.leadEmpty": "No credits left. You can still open & download certificates from history.",
      "hub.creditsLeft": "Credits left",
      "hub.creditsUsed": "Credits used",
      "hub.creditsTotal": "Total credits",
      "hub.start": "Start new mission →",
      "hub.noCredits": "No credits left",
      "hub.logout": "Switch account / Logout",
      "hub.history": "History & download",
      "hub.historyEmpty": "No history yet. Finish a mission to see it here.",
      "hub.openCert": "Open certificate / PDF",
      ...
      "result.review": "Download questions, key & discussion",
      ...
      "review.print": "Print / Save questions PDF",
      "review.back": "← Back to Results",
      "review.title": "Question File & Discussion",
      "review.kicker": "After the mission is complete",
      "review.lead": "Questions, your answers, the key, and discussion. Missed items are highlighted.",
      "review.empty": "The question file is available after you finish a mission on this device.",
      "hub.openReview": "Questions & discussion",
